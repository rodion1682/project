<template>
  <div class="relative min-h-screen px-4 pb-[166px] pt-[124px]">
    ...
    <div class="relative z-[1] mx-auto max-w-[1320px]">
      ...
      <!-- Pagination -->
      <div
        v-if="!loading && myPacks.length && pagination.total > filters.perPage"
...
import PackCard from './PrdocutsPackPage/components/PackCard.vue'
